  ...
  p.exercise({
    ...
    gen: function (r) {
      var casos = [
        ...
        { txt: 'Quienes duermen menos de 5 horas engordan más.', tipo: 'conf',
          por: 'El estrés y los turnos de noche afectan al sueño y al peso a la vez. Puede haber además efecto directo, pero la confusión está ahí.' },
