...
Course.topic('ge-transformaciones', function (p) {
  ...
  p.util('Cada vez que arrastras, giras o amplías algo en una pantalla se está aplicando una de estas ' +
    ...
    'los videojuegos las guardan como matrices y las encadenan multiplicando, que es exactamente lo que verás en el bloque de álgebra lineal. La animación de una película es una sucesión de ' +
